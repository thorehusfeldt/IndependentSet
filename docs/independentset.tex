...
\tikzset{
  auto,node distance=15mm,thick,
  remaining node/.style={thick,circle,draw,minimum size=7mm,fill=black!10},
  remaining edge/.style={thick},
  mis node/.style={thin,circle,draw,minimum size=7mm,fill=red!20},
  removed node/.style={thin,circle,draw,minimum size=7mm},
  removed edge/.style={thin,dashed}
}
  ...
  \begin{fullwidth}
    \begin{tikzpicture}
      ...
      \node[remaining node] (9) [above right of=2] {$v$};
      ...
      \node [below=5mm, align=flush center, text width=5cm] at (5)
      {Graph with isolated node ($v$).};
    \end{tikzpicture}
    \hspace{1cm}
    \begin{tikzpicture}
      \node[remaining node] (1) {};
      ...
      \node[remaining node] (7) [above right of=6] {};
      \node[remaining node] (8) [above of=7] {};
      \node[mis node] (9) [above right of=2] {$v$};
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      (2) edge node {} (9);
        ...
        \node [below=5mm, align=flush center, text width=7cm] at (5) {
          Vertex $u$ has highest degree.
        };
    \end{tikzpicture}
  \end{center}
  \begin{fullwidth}
    \begin{tikzpicture}
      ...
      (7) edge node {} (8);
        ...
        \node [below=5mm, align=flush center, text width=6cm] at (5) {
          Assume $u$ is in the MIS -- remove $u$ and its neighbors,
          since the neighbors can no longer be in the MIS.
        };
    \end{tikzpicture}
    \hspace{1cm}
    \begin{tikzpicture}
      \node[removed node] (1) {$u$};
      \node[remaining node] (2) [above left of=1] {};
      \node[remaining node] (3) [above right of=1] {};
      \node[remaining node] (4) [below left of=1] {};
      \node[remaining node] (5) [below of=1] {};
      ...
      \path[thin,dashed, every node/.style={}]
      (1) edge node {} (2)
          edge node {} (3)
          edge node {} (4)
          edge node {} (5)
      ...
      (2) edge node {} (9);
        ...
        \node [below=5mm, align=flush center, text width=6cm] at (5) {
          Assume $u$ is not in the MIS -- just remove $u$.
        };
    \end{tikzpicture}
  \end{fullwidth}
\end{enumerate}
