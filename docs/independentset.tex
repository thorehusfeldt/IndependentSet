...
\item If the input graph $G$ has a vertex $v$ without any neighbors,
  ...
  \begin{fullwidth}
    \begin{tikzpicture}
      ...
      main node/.style={circle,draw,minimum size=7mm,fill=black!10}]
      ...
      \node[main node] (6) [below right of=1] {};
      \node[main node] (7) [above right of=6] {};
      \node[main node] (8) [above of=7] {};
      \node[main node] (9) [above right of=2] {$v$};
    ...
    \begin{tikzpicture}
      ...
      \node[main node] (7) [above right of=6] {};
      \node[main node] (8) [above of=7] {};
      \node[removed node] (9) [above right of=2] {$v$};
...
\item Otherwise find a vertex $u$ of maximum degree (if there are
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[main node] (7) [above right of=6] {};
      \node[main node] (8) [above of=7] {};
      \node[main node] (9) [above right of=2] {};
  ...
  \begin{fullwidth}
    \begin{tikzpicture}
      ...
      (2) edge node {} (9);
        ...
        \node [below=5mm, align=flush center, text width=7cm] at (5) {
          Assume $u$ not in the MIS -- just remove $u$.
        };
    \end{tikzpicture}
    \hspace{1cm}
    \begin{tikzpicture}
